...
{
    public static event Action SingInComplete;
    private const string apiKey = "AIzaSyC8KNT2kSdMhy24P1MSwh-2RpXdg3NFYGE"; // You can find this in your Firebase project settings
    ...
    public static void SignUp(string email, string password, User user)
    {
        ...
        RestClient.Post($"https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key={apiKey}",
            ...
            response =>
            {
                ...
                UIRegisterScenes.Instance.Reply(UIRegisterScenes.Instance.ReplyRegisterComplete);
        ...
        RestClient.Post($"https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key={apiKey}",
            ...
            response =>
            {
                ...
                CheckEmailVerification(authResponse["idToken"], () =>
                {
                    ...
                    SingInComplete?.Invoke();
                    SceneManager.LoadScene("StartMenu");
                }, () =>
                {
                    UILoginScenes.Instance.Reply(UILoginScenes.Instance.ReplyEmailNotVerified);
                    /*Debug.Log("Email not verified");*/
                });
            }).Catch(failed =>
        {
            UILoginScenes.Instance.Reply(UILoginScenes.Instance.ReplyLoginFailed);
        });
    }
